...
2. **Verifiable literature** (170 sources, of which 100 are grade B — all with DOI/arXiv identifiers — and 51 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
- Current version: v2.37.0 (see [`VERSION`](VERSION))
...
| `REFERENCES.md` | 170 graded evidence sources (single source of truth) |
