...
[![Evidence: B (67/131)](https://img.shields.io/badge/evidence-B_67%2F131-yellow)](spec/11-traceability.md)
...
2. **Verifiable literature** (131 sources, of which 67 are grade B — all with DOI/arXiv identifiers — and 51 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
| `REFERENCES.md` | 131 graded evidence sources (single source of truth) |
