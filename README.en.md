...
[![Evidence: B (58/102)](https://img.shields.io/badge/evidence-B_58%2F102-yellow)](spec/11-traceability.md)
...
2. **Verifiable literature** (102 sources, of which 58 are grade B — all with DOI/arXiv identifiers — and 33 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/EU/SG/KR/JP + ISO + OWASP):
...
- Current version: v2.9.0 (see [`VERSION`](VERSION))
...
| `REFERENCES.md` | 102 graded evidence sources (single source of truth) |
...
> APA: Zhang, R. (2026). *AI Execution and Oversight Framework* (v2.9.0). https://github.com/ZhangRui987/agent-oversight-framework
