...
[![Version](https://img.shields.io/badge/version-2.42.1-blue)](VERSION)
...
2. **Verifiable literature** (174 sources, of which 104 are grade B — all with DOI/arXiv identifiers — and 51 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
- Current version: v2.42.1 (see [`VERSION`](VERSION))
...
| `REFERENCES.md` | 174 graded evidence sources (single source of truth) |
...
> APA: Zhang, R. (2026). *AI Execution and Oversight Framework* (v2.42.1). https://github.com/ZhangRui987/agent-oversight-framework
