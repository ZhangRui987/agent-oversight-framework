...
[![Version](https://img.shields.io/badge/version-2.0.1-blue)](VERSION)
...
- Current version: v2.0.1 (see [`VERSION`](VERSION))
...
| `REFERENCES.md` | 56 graded evidence sources (single source of truth) |
...
> APA: Zhang, R. (2026). *AI Execution and Oversight Framework* (v2.0.1). https://github.com/ZhangRui987/agent-oversight-framework
