...
2. **Verifiable literature** (134 sources, of which 70 are grade B — all with DOI/arXiv identifiers — and 51 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
| `REFERENCES.md` | 134 graded evidence sources (single source of truth) |
