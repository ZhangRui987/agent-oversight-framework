...
[![Version](https://img.shields.io/badge/version-2.16.0-blue)](VERSION)
[![License: CC BY-SA 4.0](https://img.shields.io/badge/License-CC_BY--SA_4.0-lightgrey)](LICENSE)
[![Evidence: B (58/118)](https://img.shields.io/badge/evidence-B_58%2F118-yellow)](spec/11-traceability.md)
...
2. **Verifiable literature** (118 sources, of which 58 are grade B — all with DOI/arXiv identifiers — and 47 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
- Current version: v2.16.0 (see [`VERSION`](VERSION))
...
| `REFERENCES.md` | 118 graded evidence sources (single source of truth) |
...
> APA: Zhang, R. (2026). *AI Execution and Oversight Framework* (v2.16.0). https://github.com/ZhangRui987/agent-oversight-framework
