...
[![Version](https://img.shields.io/badge/version-2.44.6-blue)](VERSION)
...
2. **Verifiable literature** (175 sources, of which 104 are grade B — all with DOI/arXiv identifiers — and 51 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
- Current version: v2.44.6 (see [`VERSION`](VERSION); this line is checked against VERSION by consistency check #38)
...
| `REFERENCES.md` | 175 graded evidence sources (single source of truth) |
