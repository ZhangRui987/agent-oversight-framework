...
[![Version](https://img.shields.io/badge/version-2.10.0-blue)](VERSION)
[![License: CC BY-SA 4.0](https://img.shields.io/badge/License-CC_BY--SA_4.0-lightgrey)](LICENSE)
[![Evidence: B (58/115)](https://img.shields.io/badge/evidence-B_58%2F115-yellow)](spec/11-traceability.md)
...
2. **Verifiable literature** (115 sources, of which 58 are grade B — all with DOI/arXiv identifiers — and 46 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
Current distribution: A:1 (Sandlock, arXiv:2605.26298, experimental reproduction) / B:58 / C:9 / D:1 / G:46. **"Insufficient evidence" is a reviewable state, not a hidden defect.**
...
- Current version: v2.10.0 (see [`VERSION`](VERSION))
...
| `REFERENCES.md` | 115 graded evidence sources (single source of truth) |
...
> APA: Zhang, R. (2026). *AI Execution and Oversight Framework* (v2.10.0). https://github.com/ZhangRui987/agent-oversight-framework
