...
[![Evidence: B (68/132)](https://img.shields.io/badge/evidence-B_68%2F132-yellow)](spec/11-traceability.md)
...
2. **Verifiable literature** (132 sources, of which 68 are grade B — all with DOI/arXiv identifiers — and 51 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
| `REFERENCES.md` | 132 graded evidence sources (single source of truth) |
