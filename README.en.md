...
[![Version](https://img.shields.io/badge/version-2.44.5-blue)](VERSION)
...
- Current version: v2.44.5 (see [`VERSION`](VERSION); this line is checked against VERSION by consistency check #38)
