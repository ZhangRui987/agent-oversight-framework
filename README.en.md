...
[![Version](https://img.shields.io/badge/version-2.15.5-blue)](VERSION)
...
- Current version: v2.15.5 (see [`VERSION`](VERSION))
...
> APA: Zhang, R. (2026). *AI Execution and Oversight Framework* (v2.15.5). https://github.com/ZhangRui987/agent-oversight-framework
