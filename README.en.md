...
[![Evidence: B (60/124)](https://img.shields.io/badge/evidence-B_60%2F124-yellow)](spec/11-traceability.md)
...
2. **Verifiable literature** (124 sources, of which 60 are grade B — all with DOI/arXiv identifiers — and 51 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
| `REFERENCES.md` | 124 graded evidence sources (single source of truth) |
