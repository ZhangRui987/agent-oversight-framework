...
[![Version](https://img.shields.io/badge/version-2.27.0-blue)](VERSION)
[![License: CC BY-SA 4.0](https://img.shields.io/badge/License-CC_BY--SA_4.0-lightgrey)](LICENSE)
[![Evidence: B (78/142)](https://img.shields.io/badge/evidence-B_78%2F142-yellow)](spec/11-traceability.md)
...
This is open problem **#15** of 29 (see `spec/13-boundaries.md`), and a priority direction for community co-development. Publicly admitting "we haven't solved wolf-packs yet" builds more trust with the expert community than claiming "we can handle everything."
...
2. **Verifiable literature** (142 sources, of which 78 are grade B — all with DOI/arXiv identifiers — and 51 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
- **Honest boundary**: 29 open problems explicitly registered (see `spec/13-boundaries.md`) — this framework's honest boundary and a problem list for researchers; includes the system's largest engineering gap, "decentralized-swarm countermeasures"
...
3. Read the 29 open problems in [`spec/13-boundaries.md`](spec/13-boundaries.md), pick one, and open an issue to discuss.
...
4. **Researchers**: reproduce the evidence chain from `REFERENCES.md`, or select a topic from the 29 open problems in `spec/13-boundaries.md`;
...
| `REFERENCES.md` | 142 graded evidence sources (single source of truth) |
