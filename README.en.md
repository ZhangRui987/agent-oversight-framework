...
[![Version](https://img.shields.io/badge/version-2.15.4-blue)](VERSION)
...
- Current version: v2.15.4 (see [`VERSION`](VERSION))
...
> APA: Zhang, R. (2026). *AI Execution and Oversight Framework* (v2.15.4). https://github.com/ZhangRui987/agent-oversight-framework
