...
3. Read the 15 open problems in [`spec/13-boundaries.md`](spec/13-boundaries.md), pick one, and open an issue to discuss.
...
4. **Researchers**: reproduce the evidence chain from `REFERENCES.md`, or select a topic from the 15 open problems in `spec/13-boundaries.md`;
