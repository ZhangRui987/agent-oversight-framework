...
[![Version](https://img.shields.io/badge/version-2.45.0-blue)](VERSION)
...
- Current version: v2.45.0 (see [`VERSION`](VERSION); this line is checked against VERSION by consistency check #38)
