...
[![Version](https://img.shields.io/badge/version-2.30.0-blue)](VERSION)
[![License: CC BY-SA 4.0](https://img.shields.io/badge/License-CC_BY--SA_4.0-lightgrey)](LICENSE)
[![Evidence: B (98/163)](https://img.shields.io/badge/evidence-B_98%2F163-yellow)](spec/11-traceability.md)
...
2. **Verifiable literature** (163 sources, of which 98 are grade B — all with DOI/arXiv identifiers — and 51 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
| `REFERENCES.md` | 163 graded evidence sources (single source of truth) |
