...
[![Version](https://img.shields.io/badge/version-2.45.1-blue)](VERSION)
[![License: CC BY-SA 4.0](https://img.shields.io/badge/License-CC_BY--SA_4.0-lightgrey)](LICENSE)
[![Evidence: B (104/176)](https://img.shields.io/badge/evidence-B_104%2F176-yellow)](spec/11-traceability.md)
...
2. **Verifiable literature** (176 sources, of which 104 are grade B — all with DOI/arXiv identifiers — and 51 are grade G governance/policy/enforcement primary evidence spanning CN/US/UK/CA/AU/EU/SG/KR/JP + ISO + OWASP):
...
- Current version: v2.45.1 (see [`VERSION`](VERSION); this line is checked against VERSION by consistency check #38)
...
| `REFERENCES.md` | 176 graded evidence sources (single source of truth) |
