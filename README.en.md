...
[![Version](https://img.shields.io/badge/version-2.13.0-blue)](VERSION)
...
- Current version: v2.13.0 (see [`VERSION`](VERSION))
...
> APA: Zhang, R. (2026). *AI Execution and Oversight Framework* (v2.13.0). https://github.com/ZhangRui987/agent-oversight-framework
