...
2. **可核查文献**（177 条来源，其中 B 级 104 条，全部含 DOI/arXiv 号；G 级 51 条治理 / 政策 / 执法一手实证，覆盖中、美、英、加、澳、欧盟、新加坡、韩国、日本九法域及 ISO、OWASP 两个国际标准组织）：
...
- 当前版本：v2.46.0（见 [`VERSION`](VERSION)；本行由门禁第 38 项与 VERSION 联动校验）
