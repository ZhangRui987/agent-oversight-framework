...
[![Version](https://img.shields.io/badge/version-2.41.0-blue)](VERSION)
...
- 当前版本：v2.41.0（见 [`VERSION`](VERSION)）
...
> APA: Zhang, R. (2026). *AI Execution and Oversight Framework* (v2.41.0). https://github.com/ZhangRui987/agent-oversight-framework
