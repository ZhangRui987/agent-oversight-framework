...
2. **可核查文献**（115 条来源，其中 B 级 58 条，全部含 DOI/arXiv 号；G 级 46 条治理 / 政策 / 执法一手实证，覆盖中、美、英、加、澳、欧盟、新加坡、韩国、日本、ISO、OWASP 八法域）：
...
当前分布：A:1（Sandlock，arXiv:2605.26298，实验复现）/ B:58 / C:9 / D:1 / G:46。**「证据不足」是可审阅的状态，不是被隐藏的缺陷。**
...
- 当前版本：v2.10.0（见 [`VERSION`](VERSION)）
