...
- 当前版本：v2.47.0（见 [`VERSION`](VERSION)；本行由门禁第 38 项与 VERSION 联动校验）
...
3. 读 [`spec/13-boundaries.md`](spec/13-boundaries.md) 的 31 条未解问题，挑一条开 Issue 讨论。
...
4. **研究者**：从 `REFERENCES.md` 出发复现证据链，或从 `spec/13-boundaries.md` 的 31 条未解问题选题；
