...
check("REFERENCES 实测 B:46", b == 46, f"实测 B={b}")
...
check("README 声明「56 条来源，其中 B 级 46 条」",
      "56 条来源，其中 B 级 46 条" in readme)
check("README 分布「A:1 / B:46 / C:8 / D:1」（含 A 级来源标注）",
      "A:1" in readme and "B:46 / C:8 / D:1" in readme)
check("CHANGELOG 声明「54 条参考文献（其中 B 级 44 条）」",
      "54 条参考文献（其中 B 级 44 条）" in chg)
check("REFERENCES 注脚「46 条 B 级、8 条 C 级、1 条 D 级（合计 56 条来源）」",
      "46 条 B 级、8 条 C 级、1 条 D 级（合计 56 条来源）" in refs)
