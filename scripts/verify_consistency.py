...
check("REFERENCES 实测 A:9", a == 9, f"实测 A={a}")
...
check("REFERENCES 注脚「9 条 A 级、104 条 B 级、10 条 C 级、1 条 D 级、51 条 G 级（合计 175 条来源）」",
      "9 条 A 级、104 条 B 级、10 条 C 级、1 条 D 级、51 条 G 级（合计 175 条来源）" in refs)
